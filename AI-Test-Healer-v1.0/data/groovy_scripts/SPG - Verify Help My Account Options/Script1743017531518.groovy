...
WebUI.verifyElementPresent(findTestObject('TripFocus/Help/Forgot_Password_Option'), 10)

WebUI.verifyElementPresent(findTestObject('TripFocus/Help/Signing_in_to_TripFocus_Option'), 10)
